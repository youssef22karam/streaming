...
class SherpaOnlineEngine(
    ...
    private var preferredLanguage: String = modelInfo.langCode.lowercase()
    ...
    override fun setLanguage(langCode: String) {
        val normalized = langCode.lowercase().trim()
        if (normalized.isNotBlank()) {
            preferredLanguage = normalized
            Log.i(TAG, "Language hint set to $preferredLanguage for ${modelInfo.displayName}")
        }
    }
